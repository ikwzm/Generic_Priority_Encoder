  ...
  set     project_name        "project_1_3072"
  ...
  #
  add_files -fileset constrs_1 -norecurse ./timing_100mhz.xdc
  #
  # Import Source files
  #
  ...
  # 
  set_property generic {MODE=1 WIDTH=3072} [current_fileset]
  #
  # Run Synthesis
  #
  launch_runs synth_1
  ...
  #
  open_run    impl_1
  report_utilization -hierarchical -file [file join $project_directory "project_1_3072.rpt" ]
  report_timing      -setup        -file [file join $project_directory "project_1_3072.rpt" ] -append
  # Close Project
  #
  close_project
