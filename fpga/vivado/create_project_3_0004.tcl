  ...
  set     project_name        "project_3_0004"
  ...
  # 
  set_property generic {MODE=3 WIDTH=4} [current_fileset]
  #
  # Run Synthesis
  #
  launch_runs synth_1
  ...
  #
  open_run    impl_1
  report_utilization -hierarchical -file [file join $project_directory "project_3_0004.rpt" ]
  report_timing      -setup        -file [file join $project_directory "project_3_0004.rpt" ] -append
  # Close Project
  #
  close_project
