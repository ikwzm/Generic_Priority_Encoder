  ...
  set     project_name        "project_1_0192"
  ...
  # 
  set_property generic {MODE=1 WIDTH=192} [current_fileset]
  #
  # Run Synthesis
  #
  launch_runs synth_1
  ...
  #
  open_run    impl_1
  report_utilization -hierarchical -file [file join $project_directory "project_1_0192.rpt" ]
  report_timing      -setup        -file [file join $project_directory "project_1_0192.rpt" ] -append
  # Close Project
  #
  close_project
