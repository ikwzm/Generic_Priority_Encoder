  ...
  set     project_name        "project_4_0064"
  ...
  # 
  set_property generic {MODE=4 WIDTH=64} [current_fileset]
  #
  # Run Synthesis
  #
  launch_runs synth_1
  ...
  #
  open_run    impl_1
  report_utilization -hierarchical -file [file join $project_directory "project_4_0064.rpt" ]
  report_timing      -setup        -file [file join $project_directory "project_4_0064.rpt" ] -append
  # Close Project
  #
  close_project
