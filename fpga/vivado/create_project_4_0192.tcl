  ...
  set     project_name        "project_4_0192"
  ...
  #
  add_files -fileset constrs_1 -norecurse ./timing_200mhz.xdc
  #
  # Import Source files
  #
  ...
  # 
  set_property generic {MODE=4 WIDTH=192} [current_fileset]
  #
  # Run Synthesis
  #
  launch_runs synth_1
  ...
  #
  open_run    impl_1
  report_utilization -hierarchical -file [file join $project_directory "project_4_0192.rpt" ]
  report_timing      -setup        -file [file join $project_directory "project_4_0192.rpt" ] -append
  # Close Project
  #
  close_project
