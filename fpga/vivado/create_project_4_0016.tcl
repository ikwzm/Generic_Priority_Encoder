  ...
  set     project_name        "project_4_0016"
  ...
  # 
  set_property generic {MODE=4 WIDTH=16} [current_fileset]
  #
  # Run Synthesis
  #
  launch_runs synth_1
  ...
  #
  open_run    impl_1
  report_utilization -hierarchical -file [file join $project_directory "project_4_0016.rpt" ]
  report_timing      -setup        -file [file join $project_directory "project_4_0016.rpt" ] -append
  # Close Project
  #
  close_project
